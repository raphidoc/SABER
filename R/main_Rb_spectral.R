...
###======================================================================
# 4. Retrieve IOPs, AOPs and BGC variables for the station under process
###======================================================================
...
for (i in 1:length(shallow_qc_stations)) {
  ...
  if (type_Rrs_below_rb == "shallow") {
    ...
    if (plot == "TRUE") {
      ggsave(filename = paste0("./Rb_spectral_station_",stat_temp,".png"), plot = g,
...
if (type_Rrs_below_rb == "shallow") {
  ...
  if (plot == "TRUE") {
    ggsave(filename = paste0("./Rb_spectral_station_",stationID,".png"), plot = g,
           scale = 1.5, width = 4.5, height = 4.5, units = "in", dpi = 300)
  }
} else {
  print("Rb retrieval is not applicable for deep water column")
