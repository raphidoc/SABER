...
Lee_forward <-  function(chl=4.96, acdom440=0.9322314, anap440=0.07, bbp.550=0.00726002,
                         z=2,rb.fraction=fA.set, plot=FALSE, verbose=FALSE,
                           realdata){
  ...
  if (plot == "TRUE") {
    ggsave(paste0("./SABER.absorption.model_chl=",C_ph ,"_acdom440=", base.CDOM,"_anap440=", base.NAP, ".png"), plot = g,
