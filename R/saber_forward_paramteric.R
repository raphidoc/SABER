...
Saber_forward_paramteric <-  function(chl=4.96, acdom440=0.9322314, anap440=0.07, 
                                      bbp.550=0.00726002, 
                           z=2, 
                           rb.fraction = fA.set,
                           slope.parametric = TRUE,
  ...
  if (verbose == TRUE) {
    print(paste0("CDOM+NAP absorption calculated from ", min(lambda), " nm to ", max(lambda), " nm."))
  }
