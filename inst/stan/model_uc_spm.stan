...
model {
  ...
  a_nap_star ~ normal(0.0051, 0.0053);
  // bb_p_star ~ lognormal(log(0.0043), 0.004);
  bb_p_star ~ normal(0.0047, 0.0005);

  a_g_s ~ normal(0.017, 0.001);
  a_nap_s ~ normal(0.0086, 0.0015);
  bb_p_gamma ~ normal(0.65, 0.21);
